...
client.on('ready', () => {
  client.user.setGame(` 『PT彡SPICY』#7508 .`);
  console.log('---------------');
...
client.user.setGame(` ON ${client.guilds.size} Servers - Prefix *help`,"https://discord.gg/Y8S4bj")
...
client.login("NjE2MTg0MDIzNDc1MjkwMTQ3.XWll9w.Icu8Y3i3k3zgOef9uHbCXydFQi8");